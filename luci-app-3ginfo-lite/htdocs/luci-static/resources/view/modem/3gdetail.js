...
simDialog: baseclass.extend({
	...
	render: function(data) {
		...
		var info = _('More information about the 3ginfo mod on the %salrescha79-cmd GitHub%s.').format('<a href="https://github.com/alrescha79-cmd/luci-app-3ginfo-mod" target="_blank">', '</a>');
